...
#            price[i]=0
        ...
        step_price_3=step_1*delta_price_1+step_2*delta_price_2+(total_car_cnt-step_1-step_2)*delta_price_3
...
# 测试
print(the_car_price_dict(11,6,0.5,13,0.7,11,0.7))
...
if __name__=='__main__':
        ...
        for step_2 in step_2_r:
            for step_3 in step_3_r:
                if step_1+step_2+step_3!=30 or 0 in (step_1,step_2,step_3):
                    ...
                    for delta_price_1 in np.arange(0.3,1.1,0.1):
                        for delta_price_2 in np.arange(delta_price_1,1.1,0.1):
                            ...
                            # min(delta_price_1,delta_price_2,delta_price_3)==max(delta_price_1,delta_price_2,delta_price_3) or 
                                ...
                                for lst in split_unit_lst:
                                    ...
                                    for total_car_lst in lst:
                                        # 每个团的司机运价字典
                                        actual_price_dict=the_car_price_dict(total_car_lst,step_1,delta_price_1,step_2,delta_price_2,step_3,delta_price_3)
                                        # 每个团的司机个数
                                        ...
                                        # 该团最后一个司机的运价
                                        last_actual_market_price=round(max(actual_price_dict.values())+base_price,2)
                                    ...
                                    actual_anticipate_profit_lst.append((lst,step_1,delta_price_1,step_2,delta_price_2,step_3,delta_price_3,total_car_cnt,last_actual_market_price_tmp,last_actual_market_price_avg_tmp,actual_mean_price_tmp,unit_actual_mean_price_tmp,actual_anticipate_profit_tmp,actual_anticipate_profit_sum))
    df=pd.DataFrame(actual_anticipate_profit_lst)
    df.describe()

    df.columns=['lst','step_1','delta_price_1','step_2','delta_price_2','step_3','delta_price_3','total_car_cnt','last_actual_market_price_tmp','last_actual_market_price_avg_tmp','actual_mean_price_tmp','unit_actual_mean_price_tmp','actual_anticipate_profit_tmp','actual_anticipate_profit_sum']
    ...
    df_final_1.to_excel(r"C:\Users\dell\Desktop\tmp_1.xlsx")
